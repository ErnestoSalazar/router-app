...
class Home extends Component {    
  ...
  handleSubmit = (e) => {
    ...
    this.props.history.push(path);// redirect the user to the URL stored in path and also add path to the history stack
    ...
    return (
      <div className="main-content home">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <input type="text" placeholder="Topic" ref={(input) => this.topic = input}/> {/* this callbacks are executed immediately executed after the Home component is mounted to de DOM */}
